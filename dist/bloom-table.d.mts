...
type CellVAlign = "top" | "center" | "bottom";
declare function getCellVAlign(cell: HTMLElement): CellVAlign | null;
declare function setCellVAlign(cell: HTMLElement, align: CellVAlign | null): void;
 ...
 */
declare const CELL_SETTING_ATTRS: readonly ["data-bg", "data-align", "data-valign", "data-pad", "data-corners"];
 ...
 */
declare function canGrowSpan(cell: HTMLElement, dx: number, dy: number): boolean;
/**
...
declare class DragToResize {
   ...
   */
  private updateHighlightForDrag;
 ...
 */
declare const cellMenuItemIds: readonly ["contentType", "alignment", "verticalAlignment", "padding", "fill", "borderColor", "borderStyle", "borderWeight", "corners", "paintFormat", "copyProperties", "pasteProperties", "merge", "split"];
